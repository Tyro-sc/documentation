...
This action applies on *Checkable* components. Syntax is : check <_component_>
...
This action applies on *UnCheckable* components. Syntax is : uncheck <_component_>
...
This action applies on *Field* Components. Syntax is : fill <_field_> with <_value_>
...
This action applies on *Field* Components. Syntax is : clear <_field_>
...
This is the same action as <<fill>>. It's just a better word to suite components like Range, DatePicket, ColorPicker...

This action applies to some *Field* Components. Syntax is : set <_field_> with <_value_>
...
This action applies on *Submissible* Components. Syntax is : submit <_component_>
...
This action applies on *Resettable* Components. Syntax is : reset <_component_>
...
This action applies on *Switchable* components. Syntax is : switchOn <_component_>
...
This action applies on *UnSwitchable* components. Syntax is : switchOff <_component_>
...
This action applies on *Item*. Syntax is : select <_item_>
...
This action applies on *Item*. Syntax is : unselect <_item_>
...
Syntax is : on <_component_> select <_item_>
or:         on <_component_> unselect <_item_>
